...
class DeepIV(BaseEstModel):
    ...
    def __init__(
        ...
        x_net : ylearn.estimator_model.deepiv.Net
            ...
            treatment or an usual classification net for discrete treatment. If None, the default neural network will be used. See :py:class:`why.estimator_model.deepiv.Net` for reference.

        y_net :  ylearn.estimator_model.deepiv.Net
            Representation of the outcome network. If None, the default neural network will be used. See :py:class:`why.estimator_model.deepiv.Net` for reference.
