...
from why import sklearn_ex as skex
from why.utils import const, logging, to_repr, to_snake_case
...
class DRFactory(BaseEstimatorFactory):
    ...
    def __call__(self, data, outcome, treatment, y_task, x_task,
                 adjustment=None, covariate=None, instrument=None, random_state=None):
        from why.estimator_model import PermutedDoublyRobust
...
class MetaLearnerFactory(BaseEstimatorFactory):
    ...
    def __call__(self, data, outcome, treatment, y_task, x_task,
                 adjustment=None, covariate=None, instrument=None, random_state=None):
        from why.estimator_model import PermutedSLearner, PermutedTLearner, PermutedXLearner
...
class SLearnerFactory(BaseEstimatorFactory):
    ...
    def __call__(self, data, outcome, treatment, y_task, x_task,
                 adjustment=None, covariate=None, instrument=None, random_state=None):
        from why.estimator_model import PermutedSLearner
...
class TLearnerFactory(BaseEstimatorFactory):
    ...
    def __call__(self, data, outcome, treatment, y_task, x_task,
                 adjustment=None, covariate=None, instrument=None, random_state=None):
        from why.estimator_model import PermutedTLearner
...
class XLearnerFactory(BaseEstimatorFactory):
    ...
    def __call__(self, data, outcome, treatment, y_task, x_task,
                 adjustment=None, covariate=None, instrument=None, random_state=None):
        from why.estimator_model import PermutedXLearner
...
class CausalTreeFactory(BaseEstimatorFactory):
    ...
    def __call__(self, data, outcome, treatment, y_task, x_task,
                 adjustment=None, covariate=None, instrument=None, random_state=None):
        from why.estimator_model._permuted import PermutedCausalTree
...
class GrfFactory(BaseEstimatorFactory):
    ...
    def __call__(self, data, outcome, treatment, y_task, x_task,
                 adjustment=None, covariate=None, instrument=None, random_state=None):
        from why.estimator_model._generalized_forest import GRForest
...
class RLossFactory(BaseEstimatorFactory):
    ...
    def __call__(self, data, outcome, treatment, y_task, x_task,
                 adjustment=None, covariate=None, instrument=None, random_state=None):
        from why.estimator_model.effect_score import RLoss
