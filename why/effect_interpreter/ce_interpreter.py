...
from why.effect_interpreter._export import _CateTreeExporter
from why.estimator_model.utils import convert2array
    ...
    def fit(
        ...
        **kwargs
        ...
        est_model : estimator_model
            est_model should be any valid estimator model of why which was
